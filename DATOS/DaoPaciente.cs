...
namespace DATOS
{
    public class DaoPaciente
    {
        ...
        public bool ExistePacientePorDni(string dni, int idExcluir)
        {
            string consulta = "SELECT id_pac FROM PACIENTE WHERE dni_pac = '" + dni + "' AND id_pac <> " + idExcluir + " AND activo_pac = 1";
            return accesoDatos.existe(consulta);
        }
