    ...
    <form id="form1" runat="server">
        <div id="contenedor">
            ...
            <div style="overflow-x:auto;">
                <asp:GridView ID="gvPaciente" runat="server" CssClass="grid" AutoGenerateColumns="False" DataKeyNames="id_pac"
                    AllowPaging="True" AutoGenerateEditButton="True" AutoGenerateDeleteButton="True"
