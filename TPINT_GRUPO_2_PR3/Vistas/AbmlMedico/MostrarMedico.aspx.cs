...
namespace TPINT_GRUPO_2_PR3.Vistas
{
    public partial class MostrarMedico : System.Web.UI.Page
    {
        ...
        private void CargarEspecialidades()
        {
            ...
            ddlEspecialidad.Items.Insert(0, new ListItem("-- Seleccione una especialidad --", "0")); // Opción por defecto
        }
        private void CargarLocalidades()
        {
            ...
            ddlLocalidad.Items.Insert(0, new ListItem("-- Seleccione una localidad --", "0")); // Opción por defecto
        }
<<<<<<< Updated upstream:TPINT_GRUPO_2_PR3/Vistas/ABML_Medico.aspx.cs
=======
        ...
        private void CargarSexo()
        {
            ...
            ddlSexo.Items.Insert(0, new ListItem("-- Seleccione un sexo --", "0")); // Opción por defecto
        ...
        private void CargarNacionallidad()
        {
            ...
            ddlNacionalidad.Items.Insert(0, new ListItem("-- Seleccione una nacionalidad --", "0")); // Opción por defecto
        }
...
>>>>>>> Stashed changes:TPINT_GRUPO_2_PR3/Vistas/AbmlMedico/AgregarMedico.aspx.cs
    }
}